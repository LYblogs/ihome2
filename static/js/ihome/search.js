...
$(document).ready(function(){
    ...
    a_id=r.split('=')[1].split('&')[0]
    a_name=r.split('me=')[1].split('&')[0]
    start_date=r.split('sd=')[1].split('&')[0]
    end_date=r.split('ed=')[1]
    console.log(r)
    $.ajax({
    url:'/home/search_info/',
    dataType:'json',
    type:'GET',
    data:{'a_id':a_id,'a_name':a_name,'start_date':start_date,'end_date':end_date},
